...
{
    public partial class Classical_Cars : Form
    {
        SqlDataAdapter adap;
        ...
        public Classical_Cars()
        {
            InitializeComponent();
           
        }

        private void Classical_Cars_Load(object sender, EventArgs e)
        {
            textBox1.Select();
            //xuiObjectAnimator1.FormAnimate(this, XanderUI.XUIObjectAnimator.FormAnimation.FadeIn, 3);
            adap = new SqlDataAdapter("SELECT * FROM classicalcar_showroom", conn);
            adap.Fill(tab);
            showdata(pos);
            textBox1.Text = "";
            textBox2.Text = "";
        ...
        private void EXOTICCARSToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            this.Hide();
        ...
        private void xuiButton3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    string sqlcmd = "INSERT INTO classicalcar_showroom(car_id,car_name,car_brand,Manufacturing_year,reg_no,chassis_no,eng_no,trasmission,horse_power,fuel_type,cost) values (" + id + ",'" + name + "','" + brand + "','" + manufact_year + "','" + reg_no + "','" + chassis_no + "','" + eng_no + "','" + trasmission + "','" + power + "','" + fuel + "','" + cost + "')";
        ...
        private void COSTUMERSToolStripMenuItem_Click_5(object sender, EventArgs e)
        {
            this.Hide();
        ...
        private void XuiButton4_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            string sqlcmd = "SELECT * FROM classicalcar_showroom";
            cmd = new SqlCommand(sqlcmd, con);
        ...
        private void XuiButton6_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    SqlConnection con = new SqlConnection(conn);
                    con.Open();
                    cmd = new SqlCommand("delete classicalcar_showroom where car_id='" + textBox1.Text + "'", con);
                    cmd.ExecuteNonQuery();
        ...
        private void XuiButton5_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    cmd = new SqlCommand("UPDATE classicalcar_showroom SET car_name='" + name + "',car_brand='" + brand + "',Manufacturing_year='" + manufact_year + "',reg_no='" + reg_no + "',chassis_no='" + chassis_no + "',eng_no='" + eng_no + "',trasmission='" + trasmission + "',horse_power='" + power + "',fuel_type='" + fuel + "',cost='" + cost + "' where car_id =" + id + "", con);
                    con.Open();
